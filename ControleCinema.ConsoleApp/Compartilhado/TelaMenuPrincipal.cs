...
namespace ControleCinema.ConsoleApp.Compartilhado
{
    public class TelaMenuPrincipal
    {
        ...
        public TelaMenuPrincipal(Notificador notificador)
        {
            ...
            telaCadastroSessao = new TelaCadastroSessao(repositorioSessao, notificador, telaCadastroSala, telaCadastroFilme);
        }
        ...
        public string MostrarOpcoes()
        {
            ...
            Console.WriteLine("Digite 3 para Gerenciar Sessões");
            Console.WriteLine("Digite 4 para Gerenciar Salas");
            Console.WriteLine("Digite 5 para Gerenciar Filmes");
